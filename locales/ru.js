export const ru = {
  ...
  updateCloudDB: `Обновить облачные данные из локальных`,
  new: 'Нов.',
  date: 'Дата',
  custId: 'Кл. №',
  prodId: 'Прод',
  ...
  minusTips1:
    'Выберите покупки ↑, проставьте для каждой позиции Общую стоимость и Количество,',
  ...
  syncCDBtips: 'Обновить облачные данные из локального хранилища'
}
